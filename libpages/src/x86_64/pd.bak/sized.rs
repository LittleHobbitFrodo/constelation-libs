...
use crate::{PageEntry, PdSizedKernelBits, PdSizedUserBits};




/// A page-sized pd table entry
#[derive(Copy, Clone)]
#[repr(transparent)]
...
impl PdSizedEntry {
    ...
    pub const fn user_bits() -> PdSizedUserBits {
        PdSizedUserBits(Self::BITS_PRESENT | Self::BITS_US | Self::BITS_PS | Self::BITS_XD)
    }
    ...
    pub const fn kernel_bits() -> PdSizedKernelBits {
        PdSizedKernelBits(Self::BITS_PRESENT | Self::BITS_PS | Self::BITS_XD)
    }
